...
import type { ParticipantMediaItem } from '@/types/media';
    ...
    <div className="space-y-6">
      ...
      {Object.entries(groupedMedia).map(([category, items]) => (
        <div key={category} className="space-y-3">
          <div className="flex items-center gap-2">
            {getCategoryIcon(category as any, 'w-4 h-4')}
            <span className={`px-2 py-1 text-xs font-medium rounded-md border ${getCategoryColor(category as any)}`}>
