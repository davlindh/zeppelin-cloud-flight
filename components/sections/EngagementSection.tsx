...
export const EngagementSection: React.FC = () => {
  ...
  return (
    <>
      <section
        className="py-20 md:py-32 bg-gradient-to-br from-blue-50 via-cyan-50 to-indigo-100"
        aria-labelledby="engagement-title"
      >
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto bg-white/80 backdrop-blur-md border border-blue-200 rounded-3xl shadow-2xl p-8 md:p-12">
            <div className="text-center">
              <h2
                id="engagement-title"
                className="text-3xl md:text-4xl font-bold font-serif text-gray-800 mb-6 leading-tight"
              >
              ...
              <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 md:p-8 max-w-2xl mx-auto shadow-lg border border-amber-100">
                <div className="flex items-center justify-center mb-4">
                  <svg className="w-12 h-12 text-amber-600 mr-3" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clipRule="evenodd" />
                  </svg>
                  <h3 className="text-2xl font-bold text-gray-800">Kommer snart</h3>
                </div>
