...
export const SystematicsSection: React.FC = () => {
    return (
<section id="systematik" aria-label="Systematics section: Zeppel Inn three-step methodology" className="py-20 md:py-32 bg-gray-100">
            <div className="container mx-auto px-6">
                ...
                <div className="mt-16 md:mt-24">
                    <div className="text-center mb-12">
                        <h3 className="text-2xl md:text-3xl font-bold font-serif text-gray-800 mb-4">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
                        ...
                        <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
                            ...
                            <div className="p-6">
                                <h4 className="font-semibold text-lg mb-2">Kunskapsdomänen</h4>
                        ...
                        <div className="bg-amber-50 border border-amber-200 rounded-2xl p-8 max-w-4xl mx-auto">
                            ...
                            <Button
                                ...
                                onClick={() => {
                                    ...
                                    window.scrollTo({
                                        top: 1800, // Approximate position of engagement section
                                        behavior: 'smooth'
                                    });
                                }}
                                className="mr-4"
