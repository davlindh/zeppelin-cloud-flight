// Shared media components - used by both admin and public contexts
export { MediaApprovalBadge } from './MediaApprovalBadge';
export { MediaCardAdmin } from './MediaCardAdmin';
// Note: MediaGrid is exported from core/index.ts to avoid duplicate exports
